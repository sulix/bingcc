...
__asm__(".symver dn_expand,dn_expand@GLIBC_NOT_AVAILABLE_BEFORE_2.34");
...
__asm__(".symver res_mkquery,res_mkquery@GLIBC_NOT_AVAILABLE_BEFORE_2.34");
...
__asm__(".symver res_query,res_query@GLIBC_NOT_AVAILABLE_BEFORE_2.34");
__asm__(".symver res_querydomain,res_querydomain@GLIBC_NOT_AVAILABLE_BEFORE_2.34");
__asm__(".symver res_search,res_search@GLIBC_NOT_AVAILABLE_BEFORE_2.34");
